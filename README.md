...
- Determinação de raízes de equações não lineares unidimensionais 
    ...
    - [Caderno 6 - Método de Newton: Sair pela Tangente sem Perder o Rumo](/ipynb/aula-05-newton.ipynb) (2h)
...
- Resolução de sistemas de equações multidimensionais
    ...
    - [Caderno 10 - Método de Newton para sistemas não-lineares](/ipynb/aula-09-newton-nao-linear.ipynb)
